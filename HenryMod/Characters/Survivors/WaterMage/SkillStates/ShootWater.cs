...
{
    public class ShootWater : BaseSkillState
    {
        public static float damageCoefficient = WaterMageStaticValues.gunDamageCoefficient;
        ...
        // public static GameObject tracerEffectPrefab = WaterMageAssets.orbProjectilePrefab;
            ...
            if (!hasFired)
            {
                ...
                if (isAuthority)
                {
                    ...
                    new BulletAttack
                    {
                        ...
                        hitEffectPrefab = WaterMageAssets.waterSwordHitImpactEffect,
                    }.Fire();
                }
            }
        }
