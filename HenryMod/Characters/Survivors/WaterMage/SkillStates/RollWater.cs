...
{
    public class RollWater : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            EffectManager.SimpleEffect(WaterMageAssets.waterImpaleEffect,
                animator.transform.position,
                Quaternion.LookRotation(forwardDirection), false);
            ...
            {
                characterBody.AddTimedBuff(WaterMageBuffs.armorBuff, 3f * duration);
